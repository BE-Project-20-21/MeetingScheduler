                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      ExpansionTile(
                        ...
                        children: <Widget>[TimeSlotPickerMatrix(DateFormat('EEEE').format(pickedDate).toString())],
                      ),
                      SizedBox(
                        height: 10,
                      ),
                      ExpansionTile(
                        ...
                        children: <Widget>[TimeSlotPickerMatrix(DateFormat('EEEE').format(newDates(1)).toString())],
                      ),
                      SizedBox(
                        height: 10,
                      ),
                      ExpansionTile(
                        ...
                        children: <Widget>[TimeSlotPickerMatrix(DateFormat('EEEE').format(newDates(2)).toString())],
                      ),
                      SizedBox(
                        height: 10,
                      ),
                      ExpansionTile(
                        ...
                        children: <Widget>[TimeSlotPickerMatrix(DateFormat('EEEE').format(newDates(3)).toString())],
                      ),
                      SizedBox(
                        height: 10,
                      ),
                      ExpansionTile(
                        ...
                        children: <Widget>[TimeSlotPickerMatrix(DateFormat('EEEE').format(newDates(4)).toString())],
                      ),
                      SizedBox(
                        height: 10,
                      ),
                      ExpansionTile(
                        ...
                        children: <Widget>[TimeSlotPickerMatrix(DateFormat('EEEE').format(newDates(5)).toString())],
                      ),
                      SizedBox(
                        height: 10,
                      ),
                      ExpansionTile(
                        ...
                        children: <Widget>[TimeSlotPickerMatrix(DateFormat('EEEE').format(newDates(6)).toString())],
                      ),
                      SizedBox(
                        height: 10,
                      ),
